...
document.addEventListener('DOMContentLoaded', () => {
    ...
    yesButton.addEventListener('click', () => {
        ...
        setTimeout(() => {
            letterAnimation.innerHTML = "<p class='letter-text bold-fonts' style='width: -webkit-fill-available'>Thank you, Sai will see you soon! 💖</p><p class='letter-text bold-fonts' style='width: -webkit-fill-available'>He sent you a song!!</p><iframe width='385' height='315' src='https://www.youtube.com/embed/ilNt2bikxDI?si=HPPMcT2uYNq2xPjh' frameborder='0' allow='accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share' referrerpolicy='no-referrer-when-downgrade' allowfullscreen></iframe>";
